...
export const MODULES: Module[] = [
...

  {
    ...
    ttsTriggers: [
      ...
      { id: 'm2-vocab-quizas',      screen: 'preListen',      text: "'Quizás' means 'maybe' or 'perhaps'. The accent on the á tells you to stress the last syllable: kee-SAS, not KEE-sas. Without the accent, the default stress rule would land on the second-to-last syllable, which would sound wrong. Quizás is a perfect example of how accent marks exist to override the default — and to make sure you sound natural from the very first listen.",                                                                                                                                                                                                                               language: 'en-US-with-es-419-tokens', slowVersion: false, normalVersion: true, outputFile: 'assets/audio/module-002/m2-vocab-quizas.mp3',     mvpRequired: true },
      { id: 'm2-phrase-mas-y-mas',  screen: 'preListen',      text: "The phrase 'más y más' means 'more and more'. Más with an accent is the adverb — more. Mas without an accent is a literary word for 'but' that you'll sometimes see in older texts and song lyrics. Y means 'and'. Putting them together: más y más is a phrase you'll hear in countless Spanish songs. The accent on the á is what makes it 'more', not a conjunction.",                                                                                                                                                                                                                                         language: 'en-US-with-es-419-tokens', slowVersion: false, normalVersion: true, outputFile: 'assets/audio/module-002/m2-phrase-mas-y-mas.mp3', mvpRequired: true },
