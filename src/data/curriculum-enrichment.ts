...
export const MODULE_ENRICHMENT: ModuleEnrichment[] = [
  ...
  {
    moduleId: 8,
    vocabularyTheme: 'Demonstratives and possessives — pointing at things across three distances and claiming them for any of five people',
    speakingGoal: 'User can point at any object with the right demonstrative (este / ese / aquel) and claim it for the right person (mi / tu / su / nuestro), and can disambiguate mi vs mí and tu vs tú by accent.',
    listeningSkill: "Catch mi, tu, and su at the front of noun phrases in Spanish-language music — J Balvin's 'Mi Gente' lands mi dozens of times, and every one is a possessive claim arriving a beat before the noun.",
    recyclingTargets: ['Subject pronouns yo/tú/él/ella → mi/tu/su (M5)', 'ser es for ownership frames (M6)', 'gender + number agreement (M7)', 'accent rules mi vs mí, tu vs tú (M2)'],
    vocabPack: {
      coreWords: [
      ...
      bonusWords: [
        ...
        { spanish: 'nuestro / nuestra', english: 'our (masc. / fem.)' },
        { spanish: 'mí', english: 'me (after a preposition — para mí)' },
      ],
      phraseChunk: 'Es mi canción favorita.',
      speakingPattern: 'Este libro es mi libro. / Esa canción es tu canción. / Aquel verano es su recuerdo.',
    },
    speakingPrompts: {
      prompts: [
        "Say: 'Este libro es mi libro.' — point at a book and claim it.",
        "Say: 'Esa canción es tu canción.' — name the song the other person is playing.",
        "Say: 'Es para mí.' — use mí (with accent) after the preposition para.",
      ],
      sentenceFrames: [
        'Este ___ es mi ___. / Esta ___ es mi ___.',
        'Ese ___ es tu ___. / Esa ___ es tu ___.',
        'Aquel ___ es su ___. / Aquella ___ es su ___.',
      ],
      miniChallenge: "Pick three objects in the room. Say each one twice — first with a demonstrative (este / esa / aquel), then with a possessive (mi / tu / su). Pointing, then claiming.",
    },
    songDifficulty: {
      pace: 'medium',
      clarity: 'clear',
    ...
    survivalPhrases: [
      'Es mi ___. (It is my ___.)',
      'Es tu ___. (It is your ___.)',
      'Este / Ese / Aquel ___. (This / That / That over there ___.)',
      'Es para mí. (It is for me — note the accent on mí.)',
      'Mi canción favorita es ___. (My favorite song is ___.)',
    ],
    everydayVocabCategories: ['demonstratives', 'possessive adjectives', 'ownership frames', 'accent disambiguation'],
  },
