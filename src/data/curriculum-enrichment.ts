...
export const MODULE_ENRICHMENT: ModuleEnrichment[] = [
  ...
  {
    moduleId: 6,
    vocabularyTheme: 'Calendar, appointments, seasons, birthdays, making plans',
    speakingGoal: "User can say today's date, their birthday month, and describe the current season.",
    listeningSkill: "Recognize time words and calendar references in natural-speed music — notice 'mañana' doing double duty as 'tomorrow' and 'morning'.",
    recyclingTargets: ['Question word ¿Cuándo? (M3)', 'subject pronouns (M5)', 'prepositions en/de (M4)'],
    vocabPack: {
      coreWords: [
      ...
      bonusWords: [
        ...
        { spanish: 'temporada', english: 'season / period' },
      ],
      phraseChunk: 'Hoy es ___.',
      speakingPattern: 'Hoy es lunes. / Hoy es el primero de mayo. / Hoy es mi cumpleaños.',
    },
    speakingPrompts: {
      prompts: [
        "Say: '¿Qué día es hoy?' then answer it.",
        "Say: 'Mi cumpleaños es en ___' — your birthday month.",
        "Say: 'En invierno hace frío, en verano hace calor' (In winter it's cold, in summer it's hot).",
      ],
      sentenceFrames: [
        'Hoy es ___ y mañana es ___.',
        'Mi cumpleaños es el ___ de ___.',
        'En ___ (season), hace ___ y me gusta ___.',
      ],
      miniChallenge: "Tell someone your birthday (month + day) and what season it falls in. Then say what you want to do that day.",
    },
    songDifficulty: {
      pace: 'medium',
      clarity: 'moderate',
    ...
    survivalPhrases: [
      ...
      '¿Cuándo? (When?)',
      'Esta semana. / La próxima semana. (This week. / Next week.)',
    ],
    everydayVocabCategories: ['calendar & dates', 'seasons & weather', 'making plans'],
  },

  {
    moduleId: 7,
    vocabularyTheme: 'Prices, quantities, phone numbers, age, addresses — numbers in real life',
    speakingGoal: 'User can say their age, phone number, give prices, count to 1,000, and use ordinals (first, second, third).',
    listeningSkill: 'Catch number words embedded in fast speech — ages, years, and countdowns appear constantly in songs and everyday talk.',
    recyclingTargets: ['Days & months (M6)', 'question word ¿Cuánto/a? (M3)', 'subject pronouns (M5)'],
    vocabPack: {
      coreWords: [
        { spanish: 'uno / una', english: 'one' },
        { spanish: 'diez', english: 'ten' },
        { spanish: 'cien', english: 'one hundred' },
        { spanish: 'primero/a', english: 'first' },
        { spanish: 'último/a', english: 'last' },
      ],
      bonusWords: [
        { spanish: 'docena', english: 'dozen' },
        { spanish: 'mitad', english: 'half' },
        { spanish: 'par', english: 'pair / couple' },
      ],
      phraseChunk: 'Tengo ___ años.',
      speakingPattern: 'Tengo veinte años. / Tengo treinta y dos años. / Tengo quince años.',
    },
    speakingPrompts: {
      prompts: [
        "Say: 'Tengo ___ años' — your real age.",
        "Say: '¿Cuánto cuesta?' then make up a price in Spanish.",
        "Say your phone number digit by digit in Spanish.",
      ],
      sentenceFrames: [
        'Tengo ___ años y mi cumpleaños es el ___.',
        'El precio es ___ pesos / dólares.',
        'Mi número de teléfono es ___.',
      ],
      miniChallenge: "Walk through a pretend market. Say three items and their prices: '___ cuesta ___ pesos.'",
    },
    songDifficulty: {
      pace: 'medium',
      clarity: 'clear',
    ...
    survivalPhrases: [
      ...
      'Mi número es ___. (My number is ___)',
      '¿Cuántos? / ¿Cuántas? (How many?)',
      'El primero / El segundo / El tercero. (The first / second / third.)',
    ],
    everydayVocabCategories: ['prices & shopping', 'personal information', 'counting & quantities'],
  },
